  ...
  return (
    <>
      <div className="overflow-hidden bg-white">
        <div className="relative mx-auto max-w-7xl py-16 px-4 sm:px-6 md:px-40 lg:px-56">
          ...
          <div className="mt-8 lg:grid lg:grid-cols-2 lg:gap-8">
            ...
            <div className="mt-8 lg:mt-0">
              ...
              <div className="prose prose-indigo mx-auto mt-5 text-gray-500 lg:col-start-1 lg:row-start-1 lg:max-w-none">
                ...
                <p>
                  Transferring ownership of your company to a third party when
                  you are ready to let go can be a daunting task - This is how
                  you get a return on the hard work invested in the business.
                  Common exit strategies include being acquired by another
                  company, the sale of equity or going public with a SPAC, it’s
